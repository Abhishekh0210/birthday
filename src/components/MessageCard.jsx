...
function MessageCard({ isActive }) {
  ...
  const message = `Vartika Walia,

Happy Birthday to the girl who does it all with such grace! 
You are the smartest, strongest, and kindest person I know. 
Watching you crush your goals this year has been a highlight for me. 
